;(function(w, d, undefined) {
  ...
  Protagonist.prototype = {
    ...
    start: function(){
      ...
      Game.addEventListener('mousedown', function(){that.fire = true;});
      d.addEventListener('mouseup', function(){that.fire = false;});
      Game.addEventListener('mousemove', that.changeDirection);
      d.addEventListener('mouseout', function(){that.fire = false;});
    },
    stop: function(){
      var that = this;
      ...
      d.removeEventListener('mouseout', function(){that.fire = false;});
    },
    drawTK: function(evt){
